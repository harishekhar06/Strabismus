...
from PySide6.QtWidgets import (QApplication, QFrame, QLabel, QMainWindow, QProgressBar, QPushButton, QSizePolicy,
                               QWidget, QGraphicsDropShadowEffect, QFileDialog, QMessageBox)
...
class MainScreen(QMainWindow):
    def __init__(self):
        ...
        self.ui.setupUi(self)
        self.ui.camBtn.clicked.connect(self.camaccess)
        self.ui.fileBtn.clicked.connect(self.open_file_dialog)
        self.ui.homeBtn.clicked.connect(self.show_pop)

    def show_pop(self):
        message = QMessageBox()
        message.setWindowTitle("Message")
        message.setText("Error 404! not found")
